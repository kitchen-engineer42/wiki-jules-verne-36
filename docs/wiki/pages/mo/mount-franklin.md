...
id: mount-franklin
type: place
label: Mount Franklin
aliases: []
tags: [place, volcano, exploration]
description: 'The volcano that dominates Lincoln Island in The Mysterious Island.'
...
Mount Franklin is a true volcanic mountain with spurs radiating from its base. The settlers travel among "the powerful spurs which supported Mount Franklin towards the west" (MI-015-039), ridges that partition the island into distinct districts.

Its volcanic nature becomes explicit as the story advances, when "the volcano arose in the north" of the island (MI-026-002) — the geological force that will ultimately shape the settlers' fate.

## Connections

Mount Franklin is the central feature of [[Lincoln Island]], the domain of [[Cyrus Harding]] and his companions. Its eruption is bound up with the fate of the island in *[[The Mysterious Island]]*, the volcanic catastrophe that ends the castaways' years of settlement.
