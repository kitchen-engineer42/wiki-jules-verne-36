...
type: character
label: Professor Lidenbrock
aliases: [Professor Liedenbrock, Otto Lidenbrock, Liedenbrock]
tags: [character, exploration, science]
description: 'The impetuous German professor who leads the descent to the centre of the earth.'
...
Lidenbrock is a man of restless motion and formidable learning. So brisk is his temperament that he walked by mathematical strides (JCE-001-027), and even in the street he moved as if driven.

He was acknowledged to be quite a polyglot (JCE-002-036), a savant of wide accomplishment, yet frequently greatly abstracted (JCE-005-003), so absorbed in his studies that the ordinary world escapes him. His insistence that only scientific arguments carry weight (JCE-006-002) defines both his brilliance and his impatience.
...
- [[Journey to the Center of the Earth]] — as the leader of the expedition.
