---
id: tabor-island-castaway
type: event
label: The Tabor Island Castaway
aliases: [Discovery of Ayrton]
tags: [event, adventure, discovery]
description: 'The colonists find a man on Tabor Island reduced by solitude to a savage state.'
...
The discovery raises the novel's great question of whether a fallen man can be restored. When one colonist protests that the creature has no sense, Harding answers that "only a few months ago the wretched creature was a man like you and me" (MI-037-023), and resolves to bring him back to humanity. That the castaway appeared no longer to belong to the human species (MI-037-019) makes his slow redemption — as the reformed convict Ayrton — one of the book's central movements.

## Participants & Setting

- Found on Tabor Island by the colonists of [[Lincoln Island]].
- Restored to humanity under [[Cyrus Harding]].
