...
label: Sargasso Sea
aliases: []
tags: [place, ocean, submarine]
description: 'The weed-choked Atlantic region the Nautilus crosses in Twenty Thousand Leagues Under the Seas.'
...
The Sargasso Sea is defined by the currents that enclose it. It sits within the whirl of the Gulf Stream system, the great warm current whose branching waters take at least three years to circle the region (TTLU-035-004), leaving the interior a becalmed pool.

Its most striking feature is the floating vegetation. The sea is carpeted with grasses, algae, and fucus plants (TTLU-035-005), a "tightly woven carpet" of weed (TTLU-035-006) so dense that it forms a genuine oceanic prairie stretching to the horizon.

## Connections

The Sargasso Sea is one of the many marine regions traversed by the [[Nautilus]] under [[Captain Nemo]] during the voyage recounted in *[[Twenty Thousand Leagues Under the Seas]]*.
