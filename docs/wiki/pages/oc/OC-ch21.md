...
It took more than half an hour to settle on a suitable landing-place. At length, a small semi-circular creek was discovered among the rocks, which appeared advantageous, because, if circumstances should so require, it would form a safe anchorage for both the _Dobryna_ and the _Hansa_.
