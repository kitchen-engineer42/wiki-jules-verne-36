...
<!-- [event] ○ 建序 39 return-to-earth-by-balloon ｜ pn_anchor OC-044（章题句「When the balloon had reached an elevation of about 2,500 yards」，Gallia 彗星复近地时众乘自制气球离 Gallia 返地球的终局；OC-042「Servadac 探测结果」+ OC-043「彗星复近之后果」+ OC-045 邻章可补）｜ 作品 Off on a Comet（OC，现仅 1 event=comet-collision 彗星撞地掠人入太空之始，掘第二事件——乘气球返地球）｜ 事件：Gallia 彗星运行复近地球，Servadac 一行制热气球于近地之刻升空脱 Gallia、越 Gallian Sea、终返地球 ｜ 候选 PN：OC-043-002 昼夜倏忽六时一轮 + OC-043-003 一年将两千八百八十日 + OC-044-001 悬网炉燃干草充气 + OC-044-002 足下 Gallian Sea 之盆（建时须逐句核制球-升空-返地序列、剔 comet-collision 撞地之始别线）｜ aliases [The Ascent from Gallia, Escape from the Comet] ｜ 链 [[Off on a Comet]]（work 页）｜ OC 2-char 无需 Note ｜ dup-check：exact-slug return-to-earth-by-balloon + 变体(gallia-balloon-ascent/escape-from-gallia) 全 ABSENT；registry sweep 无 Gallia 返地 event 覆盖 -->
